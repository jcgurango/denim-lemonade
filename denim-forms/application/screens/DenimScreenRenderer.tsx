...
import { DenimQueryConditionOrGroup, DenimRecord } from 'denim';
import { DenimIcon, useDenimUser, isMobile } from '../../forms';
...
const DenimScreenRenderer: FunctionComponent<DenimScreenRendererProps> = ({
  ...
  const renderScreen = () => {
    ...
    if (schema.type === 'view') {
      ...
      return (
        <>
          <DenimModal visible={!!state.pendingRecordDeletion}>
            <div
              style={{
                textAlign: 'center',
                fontSize: 18,
